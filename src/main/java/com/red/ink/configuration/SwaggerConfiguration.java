...
public class SwaggerConfiguration {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Ajith", "", "ajith02051997@gmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Insurence", "JWT", "1.0", "urn:tos",
